...
public class PruebaDateFormatSimpleDF {
	...
	public static void main(String[] args) {
		...
		// Prueba de nuestro método para formatear de forma personalizada 
		// una fecha
	...
	/**
	 * Método que recibe una fecha tipo Calendar y la devuelve la fecha
	 * en formato completo:
	...
	/**
	 * Método que recibe una fecha tipo Calendar y la devuelve con
	 * un patrón que yo estoy personalizando con la ayuda de la clase 
	 * SimpleDateFormat
	 * 
	 * @param fechaCalendar
	 * @return
