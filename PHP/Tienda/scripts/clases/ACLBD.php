...
public function anadirRole($nombre, $permisos=array()){
    ...
    $consulta = "INSERT INTO `acl_roles` (`cod_roles`, `nombre_rol`, `permiso1`, `permiso2`, `permiso3`, `permiso4`, `permiso5`, `permiso6`, `permiso7`, `permiso8`, `permiso9`, `permiso10`) ";
...
public function getCodRole($nombre){
    ...
    $consulta = "SELECT cod_roles from acl_roles where nombre_rol = '$nombre'";

    $resul = $this->_sqli->query($consulta)->fetch_array();

    return (is_null($resul)? false : $resul[0]);
...
public function getPermisosRole($codRole){
    $consulta = "SELECT `permiso1`, `permiso2`, `permiso3`, `permiso4`, `permiso5`, `permiso6`, `permiso7`, `permiso8`, `permiso9`, `permiso10` FROM `acl_roles` WHERE cod_roles = $codRole";
