...
public class PruebaCalendarGregorianCalendar {
	...
	public static void main(String[] args) {
		...
		// ----------------------------------------------------------
		// Calcular cuando fue nuestro cumpleaños en el año 2017
		// ----------------------------------------------------------
		Calendar fecCumple = new GregorianCalendar(1997,6,18);
		int diaCumple = fecCumple.get(Calendar.DAY_OF_WEEK);
		System.out.println("Mi cumple en 1997 fue: "+
		...
		// ----------------------------------------------------------
		// Cambiar el año de el cumple a 2020
		fecCumple.set(Calendar.YEAR, 2018);
		System.out.println("Mi cumple en 2020 fue: "+
				fecCumple.get(Calendar.DAY_OF_WEEK)); 	
		
		// Crear una nueva fecha con un valor no valido
		Calendar fec6 = new GregorianCalendar(2019,1,45);
		...
		Calendar fechaUltimoDiaClase = new GregorianCalendar(2018,5,22);
