...
/**
 * Clase que controla el funcionamiento de la calculadora, se podría considerar esta
 * clase como el modelo de la aplicación, es decir la parte lógica. Aunque en este
 * caso, se está mezclando con la parte gráfica, por tanto no es un modelo "puro"
 * 
...
public class ProcesaDatos 
{
	...
	private double op1, op2;   // Operandos con los que hacer la operación indicada
	private char operacion;    // Operación a realizar, podrá ser +,-,*,/
	private int estado;        // Estado en que se encuentra la calculadora en un momento dado
	                           // siguiendo la MAQUINA DE ESTADOS, del enunciado de la práctica
	  // Los valores que tomará la variable estado serán:
	  // 0 -- No hemos recibido aún nada o hemos comenzado de nuevo, se espera un 
	  ...
	  // 5 -- Hemos recibido un número y un operador y estamos a la espera de un 
	  //   -- dígito o del signo "-"
	  ...
	  // 10-- Ya se ha realizado la operación, se espera un nuevo operador
	...
	/**
	 * Método para el control de la calculadora
	 * @param valor --> Se correponderá con el valor correspodiente al botón pulsado, o tecla pulsada,
	 *                  es decir, uno de los dígitos del 0 al 9, una de las operaciones (+,-,*,/), el
	 *                  símbolo "." o bien el símbolo "="
	 *                  
	 * @throws MiExcepcion --> Se relanza si algo va mal en la calculadora, se capturará desde el 
	 *                         Controlador
	 */
	public void procesa(char valor) throws MiExcepcion
	{
		...
		switch (estado)  // Va controlando la evolución de la calculadora
		{
	    ...
	    // Hemos recibido un número y un operador y estamos a la espera de un dígito
